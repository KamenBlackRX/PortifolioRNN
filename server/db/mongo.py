...
class Mongo:
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs is not None:
            ...
            if 'maxDelayServer' in kwargs.keys():
                maxDelayServer = kwargs['maxDelayServer']
        try:
            self.client = MongoClient(host, port, serverSelectionTimeoutMS=maxDelayServer)
        except pymongo.errors.ServerSelectionTimeoutError as err:
            print("Error in trying to connect: %s", err)
    ...
    def read_image_from_grid(self, query, **kwargs):
        """
